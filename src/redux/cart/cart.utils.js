...
export const removeItemFromCart = (cartItems, cartItemToRemove) => {
  ...
  if (existingCartItem.quantity === 1) {
    //here i am keeping all the cartitems where id is not the same id as the cart item to remove, or in other words, it is removing the cart item to remove from the list.
